...
```bash
composer require boss24/assets
```
...
'providers' => [
    ...
    Boss24\Assets\Providers\AssetsServiceProvider::class,
];
```
...
'aliases' => [
    ...
    'Assets' => Boss24\Assets\Facades\AssetsFacade::class,
];
```
...
```bash
php artisan vendor:publish --provider="Boss24\Assets\Providers\AssetsServiceProvider" --tag=config
```
